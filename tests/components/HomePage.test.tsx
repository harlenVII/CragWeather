...
describe("HomePage ?q= redirect", () => {
    ...
    await render(
      await HomePage({
        searchParams: Promise.resolve({
          q: "https://www.mountainproject.com/route/105748662/the-nose",
        }),
      }),
    );
  ...
  it("does not redirect when ?q= is absent", async () => {
  ...
  it("ignores ?mp= param (deprecated)", async () => {
    await render(
      await HomePage({
        searchParams: Promise.resolve({
